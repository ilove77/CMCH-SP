...
--- 程序名稱：getDrugBranchInStockGrantQty
--- 程序說明：取得藥品全院入庫消耗量
--- 編訂人員：蔡易志
--- 校閱人員：孫培然
--- 修訂日期：2021/07/30
CREATE FUNCTION [fn].[getDrugBranchInStockGrantQty] (@tableName VARCHAR(20), @stockNo CHAR(04), @drugCode INT, @inStockTime1 DATETIME, @inStockTime2 DATETIME)
RETURNS INT
AS BEGIN
