...
CREATE INDEX DrugTransKey6 ON  DrugTrans(InStockTime)  INCLUDE(InStockNo,DrugCode,TranType,Qty);
CREATE INDEX DrugTransKey7 ON  DrugTrans(OutStockTime) INCLUDE(OutStockNo,DrugCode,TranType,Qty);
